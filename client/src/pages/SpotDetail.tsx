...
export default function SpotDetail() {
  ...
  const nativeClass = isNative ? 'pt-[env(safe-area-inset-top)] pb-[calc(3rem+env(safe-area-inset-bottom))]' : '';
  ...
  if (isWebcam) {
    return (
      <div className={`min-h-screen bg-background flex flex-col ${isNative ? 'pt-[env(safe-area-inset-top)] pb-[calc(3rem+env(safe-area-inset-bottom))]' : 'pb-20'}`}>
        <Header />
